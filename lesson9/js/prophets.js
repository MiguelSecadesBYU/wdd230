...
fetch(requestURL)
  ...
  function displayProphets(prophet) {
    ...
    //Change the textContent property of the p element to contain the prophet's birthday
    birth.textContent = 'Date of Birth: ' + prophet.birthdate;

    //Change the textContent property of the p element to contain the prophet's place of birthday
